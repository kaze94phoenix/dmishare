	...
	<div class="row">
					...
					<div class="panel-heading">Actions</div>
						<div class="panel-body">
							<ul class="nav nav-pills nav-stacked">
								<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;New Ranking'), array('action' => 'add'), array('escape' => false)); ?></li>
		...
		<div class="col-md-9">
			<table cellpadding="0" cellspacing="0" class="table table-striped">
				<thead>
					<tr>
						...
						<th><?php echo $this->Paginator->sort('ranking_date'); ?></th>
			...
			<?php echo $this->Html->link($ranking['Work']['title'], array('controller' => 'works', 'action' => 'view', $ranking['Work']['id'])); ?>
						...
						<td><?php echo h($ranking['Ranking']['ranking_date']); ?>&nbsp;</td>
						<td><?php echo h($ranking['Ranking']['points']); ?>&nbsp;</td>
						<td class="actions">
							<?php echo $this->Html->link('<span class="glyphicon glyphicon-search"></span>', array('action' => 'view', $ranking['Ranking']['id']), array('escape' => false)); ?>
							<?php echo $this->Html->link('<span class="glyphicon glyphicon-edit"></span>', array('action' => 'edit', $ranking['Ranking']['id']), array('escape' => false)); ?>
							<?php echo $this->Form->postLink('<span class="glyphicon glyphicon-remove"></span>', array('action' => 'delete', $ranking['Ranking']['id']), array('escape' => false), __('Are you sure you want to delete # %s?', $ranking['Ranking']['id'])); ?>
						</td>
					</tr>
				<?php endforeach; ?>
				</tbody>
