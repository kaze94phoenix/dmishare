<div class="worksTags index">

	<div class="row">
		<div class="col-md-12">
			<div class="page-header">
				<h1><?php echo __('Works Tags'); ?></h1>
			</div>
		</div><!-- end col md 12 -->
	</div><!-- end row -->
	...
	<div class="row">
					...
					<div class="panel-heading">Actions</div>
						<div class="panel-body">
							<ul class="nav nav-pills nav-stacked">
								<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;New Works Tag'), array('action' => 'add'), array('escape' => false)); ?></li>
		...
		<div class="col-md-9">
			<table cellpadding="0" cellspacing="0" class="table table-striped">
				<thead>
					<tr>
						...
						<th><?php echo $this->Paginator->sort('tag_date'); ?></th>
						<th class="actions"></th>
					</tr>
				</thead>
				<tbody>
				<?php foreach ($worksTags as $worksTag): ?>
					<tr>
						<td><?php echo h($worksTag['WorksTag']['id']); ?>&nbsp;</td>
								<td>
			...
			<?php echo $this->Html->link($worksTag['Tag']['name'], array('controller' => 'tags', 'action' => 'view', $worksTag['Tag']['id'])); ?>
						...
						<td><?php echo h($worksTag['WorksTag']['tag_date']); ?>&nbsp;</td>
						<td class="actions">
							<?php echo $this->Html->link('<span class="glyphicon glyphicon-search"></span>', array('action' => 'view', $worksTag['WorksTag']['id']), array('escape' => false)); ?>
							<?php echo $this->Html->link('<span class="glyphicon glyphicon-edit"></span>', array('action' => 'edit', $worksTag['WorksTag']['id']), array('escape' => false)); ?>
							<?php echo $this->Form->postLink('<span class="glyphicon glyphicon-remove"></span>', array('action' => 'delete', $worksTag['WorksTag']['id']), array('escape' => false), __('Are you sure you want to delete # %s?', $worksTag['WorksTag']['id'])); ?>
						</td>
					</tr>
				<?php endforeach; ?>
				</tbody>
